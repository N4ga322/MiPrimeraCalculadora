...
import com.example.mycalculadorauno.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
     ...
     fun caculatorInit(view: View) {
        // Toast.makeText(this, "Ingrese los valores deseados", Toast.LENGTH_SHORT).show()
         var button = view as Button
         var buttonText = button.text.toString()
         var concat = tvRes?.text.toString() + buttonText
         var show = zerosIzqOut(concat)
         if (buttonText=="="){
             var result = 0.0
             try {
                 result=eval(tvRes?.text.toString())
    ...
    fun zerosIzqOut (str:String):String{
        var i = 0
